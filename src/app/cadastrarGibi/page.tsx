...
import { cadastrarGibi } from "@/services/cadApiGibi";

export default function CadastrarGibi() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await cadastrarGibi({ title, descricao, autor });
      ...
      alert("Gibi cadastrado com sucesso!");
    } catch (error) {
      alert("Erro ao cadastrar gibi.");
    }
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black-100">
      <div className="w-full max-w-md p-6 bg-white shadow-md rounded-md">
        <h2 className="text-2xl font-bold text-center text-gray-800 mb-4">Cadastro de Gibi</h2>
